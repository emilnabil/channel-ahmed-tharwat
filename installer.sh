...
# ###########################################
#
# Command: wget https://raw.githubusercontent.com/emilnabil/channel-ahmed-tharwat/main/installer.sh -qO - | /bin/sh
#
# ###########################################
...
TMPDIR='/tmp'
PACKAGE='astra-sm'
MY_URL='https://raw.githubusercontent.com/emilnabil/channel-ahmed-tharwat/main'
...
wget $MY_URL/channels_backup_by-Ahmed-Tharwat-Aelnily.tar.gz -qP $TMPDIR
...
#########################
rm -rf ${TMPDIR}/channels_backup_by-Ahmed-Tharwat-Aelnily.tar.gz
rm -rf ${TMPDIR}/* astra-
